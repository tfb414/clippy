(function() {
    ...
    positionElement = (event) => {
        ...
        follower.style.top = (mouse.y - follower.offsetHeight - 10) + 'px';
        return follower.style.left = (mouse.x - follower.offsetWidth / 2 - 20) + 'px';
    };
    ...
    setText = () => {
        text.innerText = buzzword();
        setTimeout(() => setText(), getRandomInt(5000, 10000));
    };
}).call(this);
...
function buzzword() {
    ...
    var objects = new Array('Let\'s', 'I can help you', 'We\'ll', 'Getting ready to');
...
'clouds', 'nosql', 'storage', 'virtualization', 'scrums', 'sprints', 'wins'
    ...
    var statement = objects[objects.length-1 % objects.length];
    statement = statement + " " + adverbs[adverbs.length-1 % adverbs.length];
    statement = statement + " " + verbs[verbs.length-1 % verbs.length];
    statement = statement + " " + adjectives[adjectives.length-1 % adjectives.length];
    statement = statement + " " + nouns[nouns.length-1 % nouns.length];
